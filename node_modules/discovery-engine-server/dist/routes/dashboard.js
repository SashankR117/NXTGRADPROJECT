...
dashboardRouter.get('/insights', (req, res) => {
    try {
        ...
        if (question && question !== 'all') {
            query += ' AND i.strategic_question = ?';
        ...
        if (actionability && actionability !== 'all') {
            query += ' AND i.actionability = ?';
            params.push(actionability);
        }
        ...
        if (segment && segment !== 'all') {
            insights = insights.filter((i) => {
                ...
                return segs.some((s) => s.toLowerCase().includes(segment.toLowerCase()));
            });
        }
