...
function generateYouTubeVideoComments(videoId) {
    const pool = [
...
export async function scrapeYouTubeComments(videoInput = 'Tev_3DymaOE') {
    const videoId = extractYouTubeVideoId(videoInput);
    let fetched = 0;
    let processed = 0;
    let errors = 0;
    const logLines = [`Starting YouTube scraper for video https://www.youtube.com/watch?v=${videoId}...`];
    let rawComments = [];
